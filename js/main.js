...
const translations = {
  ka: {
    ...
    "hero.ctaa" : "გაგზავნა",
    "gw.status.awaiting": "სტატუსი: მოლოდინის რეჟიმი",
    "gw.status.verified": "სტატუსი: მონაწილე ვერიფიცირებულია",
    "gw.prize.rare": "უნიკალური პრიზი",
    "gw.req.title": "გათამაშების მოთხოვნები",
    "gw.task.insta": "მიჰყევით @BMW-ს",
    "gw.task.verify": "ადამიანური ვერიფიკაცია",
    "gw.task.share": "გაზიარება სთორიში",
    "gw.btn.locked": "დაბლოკილია დავალებების გამო",
    "gw.btn.ready": "მონაწილეობის მიღება",
    "gw.modal.verify.title": "ვერიფიკაცია საჭიროა",
    "gw.modal.verify.text": "დაასრულეთ ყველა მოთხოვნა მონაწილეობის მისაღებად?",
    "gw.modal.btn.yes": "დიახ, გაგრძელება",
    "gw.modal.btn.no": "არა, გაუქმება",
    "gw.game.title": "რეაქციის პროტოკოლი",
    "gw.game.wait": "დაელოდეთ...",
    "gw.game.click": "დააჭირეთ ახლავე!",
    "gw.game.early": "ზედმეტად ადრეა!",
    "gw.game.success": "დეშიფრაცია დასრულდა!",
    "gw.final.title": "რეგისტრაცია დასრულებულია",
    "gw.final.thanks": "მადლობა მონაწილეობისთვის",
    "gw.final.text": "თქვენი მონაცემები შენახულია BMW_M_CONNECT ბაზაში.",
    "gw.final.id": "თქვენი ID",
    "gw.archive.title": "დასრულებული_გათამაშებების_არქივი",
        "gw.modal.exit": "გამოსვლა",
        "gw.modal.path": "გათამაშებების_არქივი",
        "gw.modal.feedback": "გამარჯვებულის_შთაბეჭდილება",
        "gw.modal.report": "აქტივობის_რეპორტი",
        "gw.modal.car.status": "ავტომობილის_სტატუსი",
        "gw.modal.entries": "მონაწილე",
        "gw.modal.verified": "ვერიფიცირებული",
        "gw.modal.owner": "მფლობელი",
        "gw.modal.location": "ლოკაცია",
        "gw.modal.date": "გადაცემის_თარიღი",
        "gw.status.given": "გაცემულია",
        "gw.status.confirmed": "დადასტურებული",
        "filter.damage": "დაზიანება",
        "filter.damage.label": "დაზიანების ტიპი",
        "filter.damage.clean": "დაუზიანებელი",
        "filter.damage.front": "წინა დაზიანება",
        "filter.damage.rear": "უკანა დაზიანება",
        "filter.year": "წელი",
        "filter.year.label": "გამოშვების წელი",
        "filter.fuel": "საწვავი",
        "filter.fuel.label": "ძრავის ტიპი",
        "filter.fuel.diesel": "დიზელი",
        "filter.fuel.petrol": "ბენზინი",
        "filter.fuel.hybrid": "ჰიბრიდი",
        "filter.presets": "პრეზეტები",
        "filter.presets.label": "სწრაფი ფასი",
        "filter.custom": "სხვა",
        "filter.custom.label": "ფასის დიაპაზონი (€)",
        "filter.custom.min": "მინ",
